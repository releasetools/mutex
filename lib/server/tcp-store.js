...
import { DEFAULT_REQUEST_TIMEOUT_MS, isLifecycleOperation, LIFECYCLE_PROTOCOL_VERSION, MAX_MESSAGE_BYTES, parseTcpAddress, PROTOCOL_VERSION, } from "./protocol.js";
export class TcpMutexStore {
    ...
    listLocks(owner = null) {
        return this.request("list", { owner });
    }
