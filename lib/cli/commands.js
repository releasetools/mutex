...
import { EXIT_ERROR, EXIT_NO_PROGRAM, EXIT_OK, EXIT_REFUSED, EXIT_UNAVAILABLE, } from "./exit-codes.js";
import { describeLockAction, describeOwner, describeOwnerMismatch, describeRecord, summarizeRecord, } from "./output.js";
 ...
 */
export async function commandLock(ctx, identifier, program, generatedIdentifier = false) {
