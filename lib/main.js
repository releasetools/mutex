...
import { GitHubClient, setFailed, setLockAcquired, setLockReleased, setSkipped, setVersion, shouldRunAction, } from "./github.js";
...
export async function run() {
    ...
    try {
        ...
        if (settings.command === "lock") {
        ...
        else if (settings.command === "unlock" ||
            ...
            if (settings.command === "release") {
                ...
                core.warning("⚠️ command: 'release' is deprecated; use 'unlock' instead.");
            }
