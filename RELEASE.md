...
- Locks now record an owner, and `unlock` refuses to break somebody else's without `--force`.
- Added `mutex renew` to extend a lock you already hold; it will not take one you do not.
